...
$(function () {
  ...
  var headerEl = document.querySelector('header.header'); // init controller

  var controller = new (scrollmagic__WEBPACK_IMPORTED_MODULE_0___default().Controller)(); // create a scene
  ...
  if (winWidth >= BREAKPOINTS.MD) {
    var $coctailsContainer = $('#coctails');
    var $productsContainer = $('#products');
    var coctails = $('.js-slick-coctails').slick({
      slidesToShow: 5,
      slidesToScroll: 5,
  ...
  $('.js-mob-menu__btn').on('click', function () {
    var $drinksBtns = $(headerEl.querySelector('.header__drinks'));
  ...
  if (winWidth < BREAKPOINTS.XL) {
    $('.js-show-sku-info').on('click', function (e) {
      $body.addClass('--active-modal');
      var $container = $(this).parents('.list-drinks__info-wrap');
      $container.addClass('--active');
      $(this).siblings('.close').one('click', function () {
