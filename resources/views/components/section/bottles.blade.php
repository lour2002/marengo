<div id="bottles">
    ...
    <section data-drink="sparkling" class="hidden">
        ...
        <ul>
            <li class="flex relative">
                ...
                <div class="absolute flex right-2/4 translate-x-2/4 bottom-2/4 translate-y-2/4 xl:right-1/4">
                    {{-- Buttons --}}
                    <button class="nav-arrow --circle --backward block rotate-180" type="button"></button>
                    <button class="nav-arrow --circle --forward block" type="button"></button>
                </div>
