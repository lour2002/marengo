{{-- TODO: entities [img] --}}
<section class="history min-h-screen bg-none md:image-background" id="history" style="--desc-img:url('/images/background.png');">
    <div class="container">
        <div class="md:translate-y-2/4 md:max-w-[860px]">
            {{-- TODO: entities [string] --}}
            <h2 class="visually-hidden">Історія MARENGO</h2>
            <header class="history__title text-blue text-lg mb-[40px]">Історія <b>MARENGO</b></header>
            {{-- TODO: entities [text] --}}
    ...
    <div class="h-[50px] bg-gradient-to-b from-beige to-white/0 relative z-10 md:hidden"></div>
    <img class="-mt-[50px] md:hidden" loading="lazy" src="/images/background-mobile.png" alt="picture">
</section>
